		...
		<section id="pinpoints" className="main-section">
			<section className="container">
				<header className="section-header">
					<h4 className="section-header-title">{pinpoints.title}</h4>
				...
				<section className="pinpoints-map">
					...
					<img
						...
						style={{ position: "absolute", visibility: "hidden" }}
					/>
					{pinpointsData.map((pinpoint: PinpointType, i: number) => {
						const isProvince = pinpoint.region.type === "province";
								...
								>
									{isProvince && (
										<>
											...
											<p className="pinpoint-identifier-description mt-05">
												{pinpoint.region.description}
											</p>
										</>
									)}
									{!isProvince && (
